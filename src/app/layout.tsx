...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "pattu sarees Vijayawada", "banarasi sarees online", "silk sarees for weddings",
    "indo western outfits", "anarkali suits online", "designer gowns for party",
    "kids designer wear", "maggam work sarees", "handloom sarees online",
    "affordable luxury fashion", "women clothing store Vijayawada", "trending lehengas 2026",
  ],
